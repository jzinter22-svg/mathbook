/* Chapter 6 — shared site behaviour: header, TOC drawer, theme toggle, progress, reveal animations.
   Fork of assets/js/site-ch5.js parametrised for Chapter 6 (نظرية الاحتمال) so earlier chapters'
   own site-chN.js files never need to change. Loaded only by chapter-6/ pages. */
(function(){
  "use strict";

  var LESSONS = [
    {href:"index.html",            title:"الصفحة الرئيسية",              root:true},
    {href:"lessons/lesson-1.html", title:"1) التجربة العشوائية وفضاء العينة"},
    {href:"lessons/lesson-2.html", title:"2) الحدث والحوادث المتنافية"},
    {href:"lessons/lesson-3.html", title:"3) التباديل والتوافيق"},
    {href:"lessons/lesson-4.html", title:"4) طرق سحب العيّنة"},
    {href:"lessons/lesson-5.html", title:"5) نسبة الاحتمال وقوانينها"},
    {href:"lessons/lesson-6.html", title:"6) تمارين شاملة على الفصل"}
  ];

  var STORAGE_KEY = "ch6_progress_v1";
  ...
  function buildHeader(){
    ...
    brand.innerHTML = '<span class="brand-badge">🎲</span><span>الفصل السادس · نظرية الاحتمال</span>';
  ...
  function buildSidebar(){
    ...
    var html = '<div class="sidebar-inner">' +
      ...
      '</div>' +
      '<a class="sidebar-brand" href="'+base+'index.html"><span class="brand-badge">🎲</span><span>الفصل السادس</span></a>' +
      '<div class="sidebar-subtitle">نظرية الاحتمال · Probability Theory</div>' +
  ...
  var BG_SYMBOLS = ["P(E)","🎲","S","∩","∪","%","C(n,r)","H/T","Ω","⚀"];
