/* Chapter 3 — shared site behaviour: header, TOC drawer, theme toggle, progress, reveal animations.
   Fork of assets/js/site-ch2.js parametrised for Chapter 3 (تطبيقات على المشتقة) so Chapter 2's own
   site-ch2.js never needs to change. Loaded only by chapter-3/ pages. */
(function(){
  "use strict";

  var LESSONS = [
    {href:"index.html",            title:"الصفحة الرئيسية",              root:true},
    {href:"lessons/lesson-1.html", title:"1) مراجعة قواعد إيجاد المشتقة"},
    {href:"lessons/lesson-2.html", title:"2) استخدام المشتقة في التقريب"},
    {href:"lessons/lesson-3.html", title:"3) النقاط الحرجة ومناطق التزايد والتناقص"},
    {href:"lessons/lesson-4.html", title:"4) النهايات العظمى والصغرى المحلية"},
    {href:"lessons/lesson-5.html", title:"5) نقاط الانقلاب وتحدب وتقعر الدالة"},
    {href:"lessons/lesson-6.html", title:"6) رسم الدوال الحقيقية"},
    {href:"lessons/lesson-7.html", title:"7) تطبيقات عملية على النهايات العظمى والصغرى"}
  ];

  var STORAGE_KEY = "ch3_progress_v1";
  ...
  function buildHeader(){
    ...
    brand.innerHTML = '<span class="brand-badge">𝑓′</span><span>الفصل الثالث · تطبيقات على المشتقة</span>';
  ...
  function buildSidebar(){
    ...
    var html = '<div class="sidebar-inner">' +
      ...
      '</div>' +
      '<a class="sidebar-brand" href="'+base+'index.html"><span class="brand-badge">𝑓′</span><span>الفصل الثالث</span></a>' +
      '<div class="sidebar-subtitle">تطبيقات على المشتقة · Applications on the Derivative</div>' +
  ...
  var BG_SYMBOLS = ["f′(x)","f″(x)","dy/dx","Δx","Δy","∩","∪","نهاية عظمى","نهاية صغرى","نقطة انقلاب"];
