/* Chapter 5 — shared site behaviour: header, TOC drawer, theme toggle, progress, reveal animations.
   Fork of assets/js/site-ch3.js parametrised for Chapter 5 (الهندسة الفراغية) so earlier chapters'
   own site-chN.js files never need to change. Loaded only by chapter-5/ pages. */
(function(){
  "use strict";

  var LESSONS = [
    {href:"index.html",            title:"الصفحة الرئيسية",              root:true},
    {href:"lessons/lesson-1.html", title:"1) الزاوية الزوجية وتعامد المستويات"},
    {href:"lessons/lesson-2.html", title:"2) المبرهنات 7 و8 و9 ونتائجها"},
    {href:"lessons/lesson-3.html", title:"3) تطبيقات على تعامد المستويات"},
    {href:"lessons/lesson-4.html", title:"4) الإسقاط العمودي على المستوي"},
    {href:"lessons/lesson-5.html", title:"5) تطبيقات على الإسقاط العمودي"}
  ];

  var STORAGE_KEY = "ch5_progress_v1";
  ...
  function buildHeader(){
    ...
    brand.innerHTML = '<span class="brand-badge">⟂</span><span>الفصل الخامس · الهندسة الفراغية</span>';
  ...
  function buildSidebar(){
    ...
    var html = '<div class="sidebar-inner">' +
      ...
      '</div>' +
      '<a class="sidebar-brand" href="'+base+'index.html"><span class="brand-badge">⟂</span><span>الفصل الخامس</span></a>' +
      '<div class="sidebar-subtitle">الهندسة الفراغية · Solid Geometry</div>' +
